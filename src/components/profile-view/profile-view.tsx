...
export const ProfileView = ({
  ...
  const blockedLable: string = !isBlocked
  ...
  const handlePasswordChange = async (data: {
    ...
    try {
      if (isOwnProfile) {
        ...
        throw new Error(
          "Функция смены пароля другого пользователя требует реализации получения userId",
        );
            ...
            {isEditing ? (
              <div className={styles.editForm}>
                ...
                <div className={styles.formGroup}>
                  ...
                  >
                    ...
                    {Object.entries(ShiftPreferenceEnum).map(([, value]) => (
              ...
              <div className={styles.infoList}>
                ...
                <div className={styles.infoItem}>
                  ...
                  <span className={styles.value}>
                    {getWorkScheduleLabel(user.workSchedule)}
                  </span>
                </div>
                <div className={styles.infoItem}>
                  <span className={styles.label}>
                    Предпочтительный тип смены
                  </span>
                  <span className={styles.value}>
                    {getShiftTypeLabel(user.preferredShiftType)}
                  </span>
                </div>
                <div className={styles.infoItem}>
      ...
      {isAvatarModalOpen && (
        <div className={styles.modalOverlay} onClick={onAvatarModalClose}>
          ...
          >
            ...
            <button className={styles.closeButton} onClick={onAvatarModalClose}>
              Закрыть
            </button>
          </div>
        </div>
